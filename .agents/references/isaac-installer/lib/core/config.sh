...
" 2>/dev/null || true)
    ...
    export WORKSPACE_LAYOUT WORKSPACE_DEFAULT_OWNER
    ...
    ARENA_BRANCH="${ARENA_BRANCH:-${CFG_REPOSITORIES_ARENA_BRANCH:-release/0.1.1}}"
    ...
    LEROBOT_TAG="${LEROBOT_TAG:-${CFG_REPOSITORIES_LEROBOT_TAG:-}}"
    export LEROBOT_UPSTREAM LEROBOT_BRANCH LEROBOT_TAG
