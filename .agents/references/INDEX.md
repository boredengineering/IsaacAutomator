...
| [`scripts/INDEX.md`](./scripts/INDEX.md) | Installation & setup shell scripts catalog & execution relationships | Active |
...
| [`isaacautomator/isaacautomator-notes.md`](./isaacautomator/isaacautomator-notes.md) | Comprehensive Isaac Automator technical guide (component versions, resolution algorithm, GCP resilience, remote 3D rendering) | Active Reference |
